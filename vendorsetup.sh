# Clone QCOM Snapdragon 660 Hals
...
git clone https://github.com/Atom-X-Devs/android_hardware_qcom-caf_sdm660_display -b snowcone-660 hardware/qcom-caf/sdm660/display
